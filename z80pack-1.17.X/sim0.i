...
# 41 "../z80sim/sim0.c" 2
# 1 "/Applications/microchip/mplabc32/v2.01/bin/../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/fcntl.h" 1 3
# 58 "/Applications/microchip/mplabc32/v2.01/bin/../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/fcntl.h" 3
# 1 "/Applications/microchip/mplabc32/v2.01/bin/../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/sys/fcntl.h" 1 3
# 49 "/Applications/microchip/mplabc32/v2.01/bin/../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/sys/fcntl.h" 3
...
# 50 "/Applications/microchip/mplabc32/v2.01/bin/../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/sys/fcntl.h" 2 3
# 170 "/Applications/microchip/mplabc32/v2.01/bin/../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/sys/fcntl.h" 3
struct flock {
 short l_type;
 short l_whence;
 off_t l_start;
...
# 189 "/Applications/microchip/mplabc32/v2.01/bin/../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/sys/fcntl.h" 3
int open (const char *, int, ...);
int creat (const char *, mode_t);
int fcntl (int, int, ...);

int flock (int, int);
# 58 "/Applications/microchip/mplabc32/v2.01/bin/../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/fcntl.h" 2 3
# 42 "../z80sim/sim0.c" 2
...
# 48 "../z80sim/sim0.c" 2
# 1 "../z80sim/../Configuration Bits.h" 1
# 25 "../z80sim/../Configuration Bits.h"
#pragma config FNOSC = PRIPLL
# 35 "../z80sim/../Configuration Bits.h"
...
# 51 "../z80sim/sim0.c" 2
# 1 "../z80sim/../SDCard/SDCard.h" 1




# 1 "../z80sim/../SDCard/../SDCard/Microchip/Include/MDD File System/FSDefs.h" 1
# 42 "../z80sim/../SDCard/../SDCard/Microchip/Include/MDD File System/FSDefs.h"
...
# 267 "../z80sim/../SDCard/../SDCard/Microchip/Include/MDD File System/FSDefs.h"
typedef struct
{
    BYTE * buffer;
    DWORD firsts;
...
# 298 "../z80sim/../SDCard/../SDCard/Microchip/Include/MDD File System/FSDefs.h"
    typedef struct
    {
        unsigned char array[3];

    } __attribute__ ((packed)) SWORD;
# 312 "../z80sim/../SDCard/../SDCard/Microchip/Include/MDD File System/FSDefs.h"
typedef struct {
...
# 451 "../z80sim/../SDCard/../SDCard/Microchip/Include/MDD File System/FSDefs.h"
typedef struct
{
    BYTE PTE_BootDes;
...
# 469 "../z80sim/../SDCard/../SDCard/Microchip/Include/MDD File System/FSDefs.h"
typedef struct
{
    BYTE ConsChkRtn[446];
    PTE_MBR Partition0;
...
# 533 "../z80sim/../SDCard/../SDCard/Microchip/Include/MDD File System/FSDefs.h"
typedef struct
{
    BYTE errorCode;
    union
...
# 91 "../z80sim/../SDCard/SDCard.h"
typedef enum{
    LOOK_FOR_EMPTY_ENTRY = 0,
    LOOK_FOR_MATCHING_ENTRY
} SEARCH_TYPE;
# 131 "../z80sim/../SDCard/SDCard.h"
typedef struct
{
    DISK * dsk;
    DWORD cluster;
...
# 832 "../z80sim/../SDCard/SDCard.h"
int FindFirst (const char * fileName, unsigned int attr, SearchRec * rec);
# 860 "../z80sim/../SDCard/SDCard.h"
int FindNext (SearchRec * rec);
# 891 "../z80sim/../SDCard/SDCard.h"
  int FSfprintf (FSFILE *fptr, const char * fmt, ...);
# 1079 "../z80sim/../SDCard/SDCard.h"
int FSerror (void);
# 1116 "../z80sim/../SDCard/SDCard.h"
int FSCreateMBR (unsigned long firstSector, unsigned long numSectors);
# 52 "../z80sim/sim0.c" 2
# 1 "../z80sim/../SDCard/Microchip/Include/MDD File System/FSDefs.h" 1
# 53 "../z80sim/sim0.c" 2
...
int main(int argc, char *argv[])
{
 ...
 register char *pn = argv[0];
    ...
    UARTSetDataRate(UART3A, 80000000ul, 115200);
    UARTEnable(UART3A, (UART_ENABLE | (UART_PERIPHERAL | UART_RX | UART_TX)));
    MDD_SDSPI_InitIO();
...
usage: printf("usage:\t%s -s -l -i -mn -fn -xfilename\n", pn);
 ...
 puts(" #      #     #  #   #          #     #    #    #     #");
 puts("#######  #####    ###            #####    ###   #     #");
 printf("\nRelease %s, %s\n", "1.17", "Copyright (C) 1987-2008 by Udo Munk");
 if (f_flag > 0)
  printf("\nCPU speed is %d MHz\n", f_flag);
 else
...
int load_file(char *s)
{
 ...
 while (((_ctype+1)[(unsigned)(int)*s] & (0x08|0x80)))
  s++;
 while (*s != ',' && *s != '\n' && *s != '\0')
  *pfn++ = *s++;
 *pfn = '\0';
...
static int load_hex(char *fn)
{
 ...
 while (fgets(&buf[0], 256, fd) != ((void *)0)) {
  s = &buf[0];
  while (((_ctype+1)[(unsigned)*s] & (0x08|0x80)))
   s++;
  if (*s != ':')
   continue;
  if (checksum(s + 1) != 0) {
